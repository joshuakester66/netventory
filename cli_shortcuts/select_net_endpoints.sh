...
SELECT_DATABASE ()
{
mysql --user=$DATABASE_USERNAME --password=$DATABASE_PASSWORD --silent -e "SELECT id,ip,mac,hostname,sysname,dns_name,syslocation,manufacturer,os,os_version,oui,category,type FROM $LOCAL_DATABASE.$LOCAL_TABLE WHERE $CRITERIA;"
}
